...
ITEMS=(
  ...
  "Granularity: page|L3 — about a page → keel|keel:granularity page"
  "Granularity: essay|L4 — an argued essay → keel|keel:granularity essay"
  "Granularity: report|L5 — multi-section, defensible → keel|keel:granularity report"
  "Granularity: sentence|L1 — one sentence, claim only → keel|keel:granularity sentence"
  "Granularity: reset (page)|back to the default → keel|keel:granularity reset"
